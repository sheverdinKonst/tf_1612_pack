...
#ifndef RTK_DIAG_DAL_MAPPER_H
#define RTK_DIAG_DAL_MAPPER_H
...
typedef struct dal_mapper_s {
    ...
    /* TRAP API */
    //nt32   (*trap_init)(uint32 );
    //nt32   (*trap_rmaAction_get)(uint32 , rtk_mac_t *, rtk_mgmt_action_t *);
    //nt32   (*trap_rmaAction_set)(uint32 , rtk_mac_t *, rtk_mgmt_action_t );
    //nt32   (*trap_rmaGroupAction_get)(uint32 , rtk_trap_rmaGroup_frameType_t, rtk_mgmt_action_t *);
    //nt32   (*trap_rmaGroupAction_set)(uint32 , rtk_trap_rmaGroup_frameType_t, rtk_mgmt_action_t );
    //nt32   (*trap_rmaLearningEnable_get)(uint32 , rtk_mac_t *, rtk_enable_t *);
    //nt32   (*trap_rmaLearningEnable_set)(uint32 , rtk_mac_t *, rtk_enable_t );
    //nt32   (*trap_rmaGroupLearningEnable_get)(uint32 , rtk_trap_rmaGroup_frameType_t, rtk_enable_t *);
    //nt32   (*trap_rmaGroupLearningEnable_set)(uint32 , rtk_trap_rmaGroup_frameType_t, rtk_enable_t );
    //nt32   (*trap_bypassStp_get)(uint32 , rtk_trap_bypassStpType_t , rtk_enable_t *);
    //nt32   (*trap_bypassStp_set)(uint32 , rtk_trap_bypassStpType_t , rtk_enable_t );
    //nt32   (*trap_bypassVlan_get)(uint32 , rtk_trap_bypassVlanType_t , rtk_enable_t *);
    //nt32   (*trap_bypassVlan_set)(uint32 , rtk_trap_bypassVlanType_t , rtk_enable_t );
    //nt32   (*trap_userDefineRma_get)(uint32 , uint32 , rtk_trap_userDefinedRma_t *);
    //nt32   (*trap_userDefineRma_set)(uint32 , uint32 , rtk_trap_userDefinedRma_t *);
    //nt32   (*trap_userDefineRmaEnable_get)(uint32 , uint32 , rtk_enable_t *);
    //nt32   (*trap_userDefineRmaEnable_set)(uint32 , uint32 , rtk_enable_t );
    //nt32   (*trap_userDefineRmaAction_get)(uint32 , uint32 , rtk_mgmt_action_t *);
    //nt32   (*trap_userDefineRmaAction_set)(uint32 , uint32 , rtk_mgmt_action_t );
    //nt32   (*trap_userDefineRmaLearningEnable_get)(uint32 , uint32 , rtk_enable_t *);
    //nt32   (*trap_userDefineRmaLearningEnable_set)(uint32 , uint32 , rtk_enable_t );
    //nt32   (*trap_mgmtFrameAction_get)(uint32 , rtk_trap_mgmtType_t , rtk_mgmt_action_t *);
    //nt32   (*trap_mgmtFrameAction_set)(uint32 , rtk_trap_mgmtType_t , rtk_mgmt_action_t );
    //nt32   (*trap_mgmtFramePri_get)(uint32 , rtk_trap_mgmtType_t , rtk_pri_t *);
    //nt32   (*trap_mgmtFramePri_set)(uint32 , rtk_trap_mgmtType_t , rtk_pri_t );
    //nt32   (*trap_mgmtFrameQueue_get)(uint32 , rtk_trap_qType_t , rtk_qid_t *);
    //nt32   (*trap_mgmtFrameQueue_set)(uint32 , rtk_trap_qType_t , rtk_qid_t );
    //nt32   (*trap_mgmtFrameLearningEnable_get)(uint32 , rtk_trap_mgmtType_t , rtk_qid_t *);
    //nt32   (*trap_mgmtFrameLearningEnable_set)(uint32 , rtk_trap_mgmtType_t , rtk_qid_t );
    //nt32   (*trap_portMgmtFrameAction_get)(uint32 , rtk_port_t , rtk_trap_mgmtType_t , rtk_mgmt_action_t *);
    //nt32   (*trap_portMgmtFrameAction_set)(uint32 , rtk_port_t , rtk_trap_mgmtType_t , rtk_mgmt_action_t );
    //nt32   (*trap_pktWithCFIAction_get)(uint32 , rtk_action_t *);
    //nt32   (*trap_pktWithCFIAction_set)(uint32 , rtk_action_t);
    //nt32   (*trap_pktWithOuterCFIAction_get)(uint32 , rtk_action_t *);
    //nt32   (*trap_pktWithOuterCFIAction_set)(uint32 , rtk_action_t);
    //nt32   (*trap_pktWithCFIPri_get)(uint32 , rtk_pri_t *);
    //nt32   (*trap_pktWithCFIPri_set)(uint32 , rtk_pri_t );
    //nt32   (*trap_cfmAct_get)(uint32, rtk_trap_cfmType_t, uint32, rtk_action_t *);
    //nt32   (*trap_cfmAct_set)(uint32, rtk_trap_cfmType_t, uint32, rtk_action_t);
    //nt32   (*trap_cfmTarget_get)(uint32, rtk_trapTarget_t *);
    //nt32   (*trap_cfmTarget_set)(uint32, rtk_trapTarget_t);
    //nt32   (*trap_cfmFrameTrapPri_get)(uint32 , rtk_pri_t *);
    //nt32   (*trap_cfmFrameTrapPri_set)(uint32 , rtk_pri_t );
    //nt32   (*trap_oamPDUAction_get)(uint32 , rtk_action_t *);
    //nt32   (*trap_oamPDUAction_set)(uint32 , rtk_action_t );
    //nt32   (*trap_oamPDUPri_get)(uint32 , rtk_pri_t *);
    //nt32   (*trap_oamPDUPri_set)(uint32 , rtk_pri_t );
    //nt32   (*trap_portOamLoopbackParAction_get)(uint32 , rtk_port_t, rtk_trap_oam_action_t *);
    //nt32   (*trap_portOamLoopbackParAction_set)(uint32 , rtk_port_t, rtk_trap_oam_action_t);
    //nt32   (*trap_routeExceptionAction_get)(uint32 , rtk_trap_routeExceptionType_t , rtk_action_t *);
    //nt32   (*trap_routeExceptionAction_set)(uint32 , rtk_trap_routeExceptionType_t , rtk_action_t);
    //nt32   (*trap_routeExceptionPri_get)(uint32 , rtk_trap_routeExceptionType_t , rtk_pri_t *);
    //nt32   (*trap_routeExceptionPri_set)(uint32 , rtk_trap_routeExceptionType_t , rtk_pri_t);
    //nt32   (*trap_mgmtFrameMgmtVlanEnable_get)(uint32, rtk_enable_t *);
    //nt32   (*trap_mgmtFrameMgmtVlanEnable_set)(uint32, rtk_enable_t);
    //nt32   (*trap_mgmtFrameSelfARPEnable_get)(uint32, rtk_enable_t *);
    //nt32   (*trap_mgmtFrameSelfARPEnable_set)(uint32, rtk_enable_t);
    //nt32   (*trap_bpduFloodPortmask_get)(uint32,  rtk_portmask_t *);
    //nt32   (*trap_bpduFloodPortmask_set)(uint32,  rtk_portmask_t *);
    //nt32   (*trap_eapolFloodPortmask_get)(uint32,  rtk_portmask_t *);
    //nt32   (*trap_eapolFloodPortmask_set)(uint32,  rtk_portmask_t *);
    //nt32   (*trap_lldpFloodPortmask_get)(uint32,  rtk_portmask_t *);
    //nt32   (*trap_lldpFloodPortmask_set)(uint32,  rtk_portmask_t *);
    //nt32   (*trap_userDefineFloodPortmask_get)(uint32,  rtk_portmask_t *);
    //nt32   (*trap_userDefineFloodPortmask_set)(uint32,  rtk_portmask_t *);
    //nt32   (*trap_rmaFloodPortmask_get)(uint32,  rtk_portmask_t *);
    //nt32   (*trap_rmaFloodPortmask_set)(uint32,  rtk_portmask_t *);
    //nt32   (*trap_rmaCancelMirror_get)(uint32, rtk_enable_t *);
    //nt32   (*trap_rmaCancelMirror_set)(uint32, rtk_enable_t);
    //nt32   (*trap_rmaLookupMissActionEnable_get)(uint32, rtk_enable_t *);
    //nt32   (*trap_rmaLookupMissActionEnable_set)(uint32, rtk_enable_t);
    //nt32   (*trap_oamTarget_get)(uint32, rtk_trapTarget_t *);
    //nt32   (*trap_oamTarget_set)(uint32, rtk_trapTarget_t);
    //nt32   (*trap_mgmtFrameTarget_get)(uint32, rtk_trapTarget_t *);
    //nt32   (*trap_mgmtFrameTarget_set)(uint32, rtk_trapTarget_t);
    //nt32   (*trap_capwapInvldHdr_get)(uint32, rtk_enable_t *);
    //nt32   (*trap_capwapInvldHdr_set)(uint32, rtk_enable_t);
